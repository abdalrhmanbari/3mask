...
export default function Catalog({title, disc}:{title:string, disc?:string}) {
  return (
    <div className='py-paddingY bg-bgGrey  px-paddingX'>
        ...
        <Button title="Spirotek" style='border border-linear text-secondary'/>
        </div>
        <div className=' grid sm:grid-cols-3 grid-cols-1 justify-center gap-[2rem] '>
            <CardCatalog img='/ffb2.png' title='Respirator (mask) KN95 FFP2 without valve'/>
            <CardCatalog img='/ffb2(1).png' title='Respirator (mask) KN95 FFP2'/>
            <CardCatalog img='/ffb2(2).png' title='Respirator (mask) KN95 Black FFP2'/>
            <CardCatalog img='/60c08ee91a179e5f76206a7bf6c0d2ba.png' title='Disposable slippers spunbond/transparent/black'/>
            <CardCatalog img='/e4129fab0141480b918396b20ba52bd5.png' title='Slippers Terry Optima Plus, disposable'/>
            <CardCatalog img='/cf838f5661eb2657d2ed4d1d170b63cc.png' title='Antiseptic gel Septel(50 ml.'/>
            <CardCatalog img='/fca42118737ba4c0d5c5a1148328d596.png' title='Protective face screen'/>
            <CardCatalog img='/7bf75f1a8a9593b1ddd5751d6617614d.png' title='Sanitizer antiseptic spray (50 ml.)'/>
            <CardCatalog img='/d2da4d770400523a10a6ba4059006dce.png' title='Respirator for children KN95 FFP2 Kitten blue'/>
        </div>
