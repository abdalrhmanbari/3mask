    ...
    <div  className=' pb-[2rem] mt-marginT'>
        <div className=' flex justify-between flex-col md:flex-row pt-[2rem] gap-[4rem] mb-[6rem]'>
            <div className='  flex flex-col gap-[2rem]  '>
                ...
                <div className=' flex flex-col gap-[0.5rem]'>
                    <span className=' flex gap-[0.5rem] items-center font-semibold'><img alt='.' src='/.png'/>55872</span>
                    <p className=' text-secondary text-sm ms-[1.5rem]'>Infected</p>
                </div>
                <div className=' flex flex-col gap-[0.5rem]'>
                    <span className=' flex gap-[0.5rem] items-center font-semibold'><img alt='.' src='/.png'/>52524</span>
                    <p className=' text-secondary text-sm ms-[1.5rem]'>Recovered</p>
                </div>
                <div className=' flex flex-col gap-[0.5rem]'>
                    <span className=' flex gap-[0.5rem] items-center font-semibold'><img alt='.' src='/.png'/>3150</span>
            ...
            <div className=' w-full  md:min-w-[45%] md:max-w-[45%] md:mt-0   m-auto'>
                <img alt='.' src='/mask-home.jpeg' className='block w-full   rounded-bl-[4rem] rounded-tr-[4rem]'/>
            </div>
        </div>
        ...
        <div className=' flex gap-[4rem] flex-col-reverse     sm:flex-row  justify-center items-center'> 
            <div className='  sm:min-w-[40%] sm:max-w-[40%] w-full '>
                <img alt='..' src='/5b3c00477f5f20adb5f0cc1c62acee6f.jpeg' className=' rounded-tl-rounded rounded-br-rounded w-full object-cover'/>
            </div>
            <div className=' flex flex-col gap-[2rem]'>
        ...
        <p className=' text-secondary text-sm'>In this article, we will tell you how you can protect yourself as much as possible and how not to harm yourself in such difficult times.</p>
            ...
            <div className='  sm:min-w-[40%] sm:max-w-[40%] w-full '>
                <img alt='..' src='/dde4f325fd6c5bd61cfc3e3f94f49cbf.jpeg' className=' rounded-tl-rounded rounded-br-rounded w-full'/>
            </div>
        </div>
        <div className=' flex gap-[4rem] flex-col-reverse     sm:flex-row  justify-center items-center'> 
            <div className='   sm:min-w-[40%] sm:max-w-[40%] w-full h-[20rem] '>
                <img alt='..' src='/350a84c65ffcb3c87da139c80cb37268.jpeg' className=' rounded-tl-rounded rounded-br-rounded w-full h-full object-cover'/>
            </div>
            <div className=' flex flex-col gap-[2rem]'>
        ...
        <div className=' bg-bgWhite flex flex-col gap-[2rem]'>
            <h1  className='text-2xl sm:text-3xl  font-semibold flex flex-col text-center'>Basic precautions<span>to protect against the new coronavirus infection</span></h1>
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[2rem]'>
                    <CartMask count={1} img='/wash-your-hands 1.png' title='Wash your hands regularly' disc='With soap for at least 20 seconds or use an alcohol-based sanitizer.' />
                    <CartMask count={2} img='/1111.png' title='Keep your distance' disc='Stay at least 1 metre away from people, especially if they have a cough, runny nose or fever.' />
                    <CartMask count={3} img='/icon (1)111.png' title='Observe the rules of hygiene' disc='If possible, avoid touching your eyes, nose and mouth with your hands and practice respiratory hygiene.' />
                    <CartMask count={4} img='/icon (2)11.png' title='Seek medical help' disc='If you develop a fever, cough or difficulty breathing, seek medical attention as soon as possible.' />
                </div>
        </div>
