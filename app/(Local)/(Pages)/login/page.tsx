...
export default function LogIn() {
  const classOut="flex flex-col gap-[0.5rem] sm:w-[20rem]"
  ...
  return (
        ...
        <div className=" flex items-center justify-center  my-[6rem] flex-col ">
          ...
          <div className=' flex flex-col justify-center items-center text-center gap-2'>
            ...
            <h2 className=' text-sm sm:text-base text-gray-500 sm:w-[30rem]'>A specialized store of certified, original protective materials for respiratory organs and protection against
