...
export default function Wholesale() {
  return (
    ...
    <Image width={200} height={200}      src='/Group 57.png'alt='mask' className=' object-cover' />
    </div>
    <div className='w-full  md:min-w-[45%] md:max-w-[45%] md:mt-0 mt-[3rem]   m-auto'>
        <Imag src='/c343c4c63ddd5623074f3e247601ef9f.jpeg' />
    </div>
    </div>
            <div className=' bg-bgGrey py-paddingY flex flex-col gap-[1rem]'>
                ...
                <CardWholesale src='/icon (1)1.png' title='Always in stock' disc='Our own warehouse guarantees the availability of products and pick-up for our customers'/>
                <CardWholesale src='/icon (1)1.png' title='Payment by bank transfer' disc='You pay for all ordered goods through the bank and receive a consignment note TORG 12'/>
                <CardWholesale src='/icon (1)1.png' title='Original products' disc='Each product has a certificate of conformity'/>
                </div>
            </div>
            <div className=' flex flex-col gap-[1rem] py-paddingY sm:w-[50rem] m-auto'>
                ...
                <div className=' grid sm:grid-cols-2 grid-cols-1 gap-[2rem]'>
                    <Input src='/user 1.png' type='text' name='name' placeholder='Your name' id='name'/>
                    <Input src='/Group00.png' type='email' name='email' placeholder='Email' id='email'/>
                    <Input src='/phone (4) 1.png' type='tel' name='phone' placeholder='Your phone' id='phone'/>
                    <Input src='/placeholder 100.png' type='text' name='address' placeholder='Delivery address' id='address'/>
                </div>
                    <Input src='/list 1.png' type='text' name='list' placeholder='List the mask models and the quantity you are interested in. For example: 8122 - 300 pcs.' id='list'/>
